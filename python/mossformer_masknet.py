...
class MossFormer_MaskNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1_decoder = nn.Conv1d(out_channels, out_channels_final, kernel_size=1, bias=False)
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        result = mx.transpose(x[0], (0, 2, 1))  # Return [B, L, out_channels_final] (first speaker only)
        return result
